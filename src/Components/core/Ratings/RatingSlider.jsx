    ...
    return (
        <div>
            <Swiper
                ...
                allowSlidePrev={true}
                slidesPerView={3} // Set slidesPerView to 3 to show 3 slides
                loop={false} // Disable looping so it stops after the 3rd slide
                spaceBetween={20}
                pagination={false}
                ...
                breakpoints={{
                    ...
                    1024: { slidesPerView: 3 }, // Limit to 3 slides on larger screens
                }}
            >
                {
